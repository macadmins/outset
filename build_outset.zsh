...
$XCODE_BUILD -project "./outset.xcodeproj" -scheme "Outset App Bundle" CODE_SIGN_IDENTITY=$APP_SIGNING_IDENTITY OTHER_CODE_SIGN_FLAGS="--timestamp" -configuration Release -derivedDataPath ./build
XCB_RESULT="$?"
